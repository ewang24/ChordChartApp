...
public class ChorusController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        header.setText(chorus.getHeaderName());
        header.setFont(Font.font("arial", FontWeight.BOLD, 20));
        chorusBox.setStyle(String.format("-fx-padding: 0 %s 0 %s", CSS.VERSE_CONTROLLER__VERSE_BOX__PADDING, CSS.VERSE_CONTROLLER__VERSE_BOX__PADDING));
        ...
        for (LyricLine lyricLine : chorus.getChordLines()) {
...
//            verseBox.getChildren().add(chordBox);
            chorusBox.getChildren().add(lyricRow);
        }
    }
